...
{
    /// <inheritdoc />
    public partial class admigrationInitial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TransportName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TravelInformations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TravelInformations_Cities_FromCityId",
                        column: x => x.FromCityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TravelInformations_Cities_ToCityId",
                        column: x => x.ToCityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Galleries_Resorts_ResortId",
                        column: x => x.ResortId,
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Galleries_TourPackages_TourPackageId",
                        column: x => x.TourPackageId,
                        principalTable: "TourPackages",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Galleries_TouristSpots_TouristSpotId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Galleries_TouristSpotId",
                table: "Galleries",
                column: "TouristSpotId");

            migrationBuilder.CreateIndex(
                name: "IX_Galleries_TourPackageId",
                table: "Galleries",
                column: "TourPackageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TravelInformations_FromCityId",
                table: "TravelInformations",
                column: "FromCityId");

            migrationBuilder.CreateIndex(
                name: "IX_TravelInformations_ToCityId",
                table: "TravelInformations",
                column: "ToCityId");
        }
